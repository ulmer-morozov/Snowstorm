...
(function (Snowstorm) {
    ...
    DataRepository.authors = [
        ...
        { id: 7, name: { first: "Саша", last: "Киселёва" }, mascotUrl: "assets/images/portfolio/house.png", about: "", promoImages: DataRepository.getPromoImages(DataRepository.getSashaKiselevaWorks()), works: DataRepository.getSashaKiselevaWorks() },
        ...
        { id: 12, name: { first: "Сергей", last: "Гудков" }, mascotUrl: "assets/images/portfolio/mascot3ва.png", about: "Иллюстратор, дизайнер. \"Люблю комиксы, мультфильмы и детские иллюстрации.\"", promoImages: DataRepository.getPromoImages(DataRepository.getSergeyGudkovWorks()), works: DataRepository.getSergeyGudkovWorks() },
    ];
