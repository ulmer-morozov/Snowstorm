...
(function (Snowstorm) {
    ...
    DataRepository.authors = [
        ...
        { id: 7, name: { first: "Александра", last: "Киселёва" }, mascotUrl: "assets/images/portfolio/house.png", about: "Городской шаман, мечтатель и путешественник. Рисует всегда и везде, на разных поверхностях, разного размера, разными материалами.", promoImages: DataRepository.getPromoImages(DataRepository.getSashaKiselevaWorks()), works: DataRepository.getSashaKiselevaWorks() },
        ...
        { id: 10, name: { first: "Катерина", last: "Воронина" }, mascotUrl: "assets/images/portfolio/fox.png", about: "\"В этом мире возможно все! Больше интенции, меньше инерции)\"", promoImages: DataRepository.getPromoImages(DataRepository.getKatyaVoroninaWorks()), works: DataRepository.getKatyaVoroninaWorks() },
